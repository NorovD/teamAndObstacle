...
public class MixedTeam implements Competitor {
    String type;
    String name;
    ...
    public MixedTeam(String type, String name, int maxRunDistance, int maxJumpHeight, int maxSwimDistance, boolean onDistance) {
        this.type = type;
        this.name = name;
